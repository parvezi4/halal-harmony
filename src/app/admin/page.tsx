    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <p className="mt-1 text-sm text-slate-400">Review flagged messages</p>
        </Link>
        ...
        >
          ...
          <p className="mt-1 text-sm text-slate-400">Approve or suspend profiles</p>
        </Link>
        ...
        >
          ...
          <p className="mt-1 text-sm text-slate-400">Review and approve photos</p>
        </Link>
        ...
        >
          ...
          <p className="mt-1 text-sm text-slate-400">Handle user complaints</p>
        </Link>
      </div>
